	...
	if($bandera){		
		...
		<input type="hidden" name="op" value="' . $op  . '">
			...
			<table class="table table-hover" style="background-color:#f1fdf3;" border="1" align="center">
				<tr>
					<th class="text-center" style="color:#f7f5f5; background-color:#330867;" colspan="8"><b>DATOS MARCA</b></th>
				</tr>
				<tr>
				...
				<tr>
					<td class="text-center" colspan="5" style="color:#f7f5f5; background-color:#6879C6"><b>Pais:</b></td>
		...
		while($row = $res->fetch_assoc()){
			...
			$html .= '<head><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css"></head>
				<tr>
					...
					<td>' . $row['pais'] . '</td>
					<td class="text-center"><a href="marcas.php?d=' . $d_del_final . '"class="text-center btn" style="color:#000000; background-color:#FA0B00" ><i class="fas fa-trash-alt"></i> Borrar</a></td>
					<td class="text-center"><a href="marcas.php?d=' . $d_act_final . '"class="text-center btn" style="color:#000000; background-color:#FAE617" ><i class="fas fa-sync-alt"></i> Actualizar</a></td>
					<td class="text-center"><a href="marcas.php?d=' . $d_det_final . '"class="text-center btn" style="color:#000000; background-color:#33D6CB" ><i class="fas fa-info-circle"></i> Detalle</a></td>
				</tr>';
		}
		$html .= '<tr>
						<th class="text-center" style="color:#f7f5f5; background-color:#330867;" colspan="8"><a href="../index.html" class="text-center btn" style="color:#f7f5f5; background-color:#6d96b3" ><b>Regresar</b></a></th>
